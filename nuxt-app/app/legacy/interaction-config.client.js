...
(function () {
  const models = [
    ...
    },
    {
      ...
      contract: 'scene-plan@1.0 / difficulty-advisory@0.2',
    ...
    },
    {
      ...
      contract: 'turn-output@0.2 / turn-qa@1.0',
  ...
  const prompts = [
    ...
    },
    {
      ...
      route: 'advisory', contract: 'scene-plan@1.0', file: 'prompts/02_nemotron_scene_and_arc_planner.md'
    },
    {
      id: 'p03-narrative-renderer', number: '03', title: 'Художественный рассказчик', modelId: 'aion-narrative',
      route: 'optional', contract: 'narration@1.0', file: 'prompts/03_aion_narrative_scene.md'
    },
    {
      id: 'p04-fallback-audit', number: '04', title: 'Fallback и канонический аудит', modelId: 'mistral-fallback',
      route: 'fallback', contract: 'turn-output@0.2 / turn-qa@1.0', file: 'prompts/04_mistral_story_fallback_and_audit.md'
    },
    {
    ...
    },
    {
      ...
      route: 'after-commit', contract: 'journal-projection@1.0', file: 'prompts/09_deepseek_journal_and_memory.md'
    },
    {
      id: 'p10-storypack-compiler', number: '10', title: 'Компилятор мира и StoryPack', modelId: 'deepseek-turn',
      route: 'pre-production', contract: 'storypack-compiled@1.0', file: 'prompts/10_deepseek_world_story_compiler.md'
    },
    {
