...
export default defineNuxtConfig({
  ...
  runtimeConfig: {
    ...
    fabulaAiNemotronPaidEnabled: false,
    fabulaAiAionEnabled: false,
    fabulaAiMediaEnabled: false,
    fabulaAiPremiumMediaEnabled: false,
    fabulaAiImageMaxCostUsd: 0,
    fabulaAiVideoMaxCostUsd: 0,
    fabulaAiTextTimeoutMs: 180_000,
    fabulaAiImageTimeoutMs: 120_000,
    fabulaAiVideoSubmitTimeoutMs: 30_000,
    fabulaAiVideoPollTimeoutMs: 20_000,
