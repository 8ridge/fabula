...
- предложи 5-6 коротких и конкретных suggested_actions: смешай action, speech и
  exploration, не повторяй одно намерение разными словами. Один вариант может
  быть неожиданным или рискованным, но обязан оставаться возможным в текущей
  сцене и не противоречить канону;
