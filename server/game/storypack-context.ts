...
Второе лицо, настоящее время, бытовой реализм, 140–280 слов.`,
    hardCanon: [
...
Второе лицо, настоящее время, 160–300 слов. Одна ясная улика и 2–4 направления.`,
    hardCanon: [
...
Второе лицо, настоящее время, 180–320 слов. Награда открывает новые действия.`,
    hardCanon: [
