...
<section class="hero" id="top">
  <div class="hero-bg" id="heroBg">
    ...
    <video class="hero-video" id="heroVideo" poster="/assets/hero_landing.jpg" muted="" loop="" playsinline="" preload="none"></video>
  </div>
  ...
  <div class="auth" id="authBox" role="dialog" aria-modal="true" aria-label="Вход">
    ...
    <form id="authForm" novalidate>
      <div class="auth-field auth-reg">
        ...
        <input type="text" id="afName" autocomplete="nickname" placeholder="Имя героя">
      </div>
  ...
  form.addEventListener('submit', async e=>{
    ...
    try{
      const {r, data} = await apiPost(reg ? '/auth/register' : '/auth/login',
        reg ? {name, email, password:pass} : {email, password:pass});
