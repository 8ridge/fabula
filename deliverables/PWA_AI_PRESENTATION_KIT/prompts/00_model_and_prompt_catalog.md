...
| [`nvidia/nemotron-3-ultra-550b-a55b`](https://openrouter.ai/nvidia/nemotron-3-ultra-550b-a55b) | анализ предметов и платный fallback планировщика | $0.50 input / $2.20 output за 1M | $0.0052–$0.0338 | высокое | средне-быстро |
| [`nvidia/nemotron-3-super-120b-a12b`](https://openrouter.ai/nvidia/nemotron-3-super-120b-a12b) | post-commit проекция журнала | $0.085 input / $0.40 output за 1M | короткий ограниченный вызов | высокое для структурной проекции | быстро |
...
- free slug: `$0`;
- Nemotron 3 Ultra: предметный анализ и платный fallback планировщика;
- Nemotron 3 Super: отдельная проекция журнала;
...
| 08 | Предметы и операции инвентаря | Nemotron 3 Ultra | обязательный внутренний вызов перед авторитетным ходом |
| 09 | Журнал и память | Nemotron 3 Super | после подтверждённой транзакции |
