...
| Минимум проекта | обычно часть авторитетного хода; дополнительный короткий вызов — доли цента |
| Максимум проекта | общий проектный предел DeepSeek-вызова $0.00812 |
